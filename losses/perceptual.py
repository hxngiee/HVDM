...
class LPIPSWithDiscriminator(nn.Module):
    ...
    def forward(self, codebook_loss, inputs, reconstructions, x_freq, rec_freq, optimizer_idx,
        ...
        freq_loss = (self.pixel_weight / 8.0) * (F.l1_loss(x_freq[0], rec_freq[0]) + F.l1_loss(x_freq[1], rec_freq[1]) + F.l1_loss(x_freq[2], rec_freq[2]) + F.l1_loss(x_freq[3], rec_freq[3]) + F.l1_loss(x_freq[4], rec_freq[4]) + F.l1_loss(x_freq[5], rec_freq[5]) + F.l1_loss(x_freq[6], rec_freq[6]) + F.l1_loss(x_freq[7], rec_freq[7]))
        ...
        if optimizer_idx == 0:
            ...
            return rec_loss + freq_loss + p_loss + g_loss + gan_feat_loss
